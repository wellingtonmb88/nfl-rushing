defmodule NflRushingBackendWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: NflRushingBackendWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/nfl_rushing_backend_web/templates",
        namespace: NflRushingBackendWeb
